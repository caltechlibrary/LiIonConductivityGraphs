...
def construct_atom_sets_reg(
    ...
    dropout_prob_init: float = 0.5,
    dropout_init: bool = False,
    dropout_prob_final: float = 0.5,
    dropout_final: bool = False,
    kernel_reg_value_init: float = 1e-4,
    kernel_reg_init: bool = False,
    kernel_reg_value_final: float = 1e-4,
    kernel_reg_final: bool = False,
    **symmetry_func_kwargs,
    ...
    if dropout_init:
        if kernel_reg_init:
            for n_neuron in n_neurons:
                out_ = Dense(n_neuron, activation=activation, kernel_regularizer=regularizers.L2(kernel_reg_value_init))(out_)
                out_ = Dropout(dropout_prob_init)(out_)
        else:
            for n_neuron in n_neurons:
    ...
    if dropout_final:
        if kernel_reg_final:
            for n_neuron in n_neurons:
                out_ = Dense(n_neuron, activation=activation, kernel_regularizer=regularizers.L2(kernel_reg_value_final))(out_)
                out_ = Dropout(dropout_prob_final)(out_)
        else:
            for n_neuron in n_neurons:
                out_ = Dense(n_neuron, activation=activation)(out_)
                out_ = Dropout(dropout_prob_final)(out_)
    ...
    def __init__(
        ...
        **symmetry_func_kwargs,
        ...
        model = construct_atom_sets_reg(
            ...
            dropout_prob_init=dropout_prob_init,
            dropout_init=dropout_init,
            dropout_prob_final=dropout_prob_final,
            dropout_final=dropout_final,
            kernel_reg_value_init=kernel_reg_value_init,
            kernel_reg_init=kernel_reg_init,
            kernel_reg_value_final=kernel_reg_value_final,
            kernel_reg_final=kernel_reg_final,
            **symmetry_func_kwargs,
        )
        ...
        self.dropout_prob_init=dropout_prob_init,
        self.dropout_init=dropout_init,
        self.dropout_prob_final=dropout_prob_final,
        self.dropout_final=dropout_final,
        self.kernel_reg_value_init=kernel_reg_value_init,
        self.kernel_reg_init=kernel_reg_init,
        self.kernel_reg_value_final=kernel_reg_value_final,
        self.kernel_reg_final=kernel_reg_final,
